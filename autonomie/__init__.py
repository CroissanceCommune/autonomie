...
# * Last Modified : mar. 03 avril 2012 14:23:06 CEST
#
# * Project : autonomie
#
"""
...
from autonomie.i18n.translater import set_deform_renderer
...
def main(global_config, **settings):
    ...
    config.add_route('estimation', '/company/{cid}/projects/{id}/estimation')
