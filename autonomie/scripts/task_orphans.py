...
def autonomie_clean_cmd():
    """Cleaning tools
    Usage:
        autonomie-clean <config_uri> taskorphans
    ...
    def callback(arguments, env):
        args = ()
        if arguments['taskorphans']:
            func = print_task_orphans
        return func(arguments, env)

    try:
        return command(callback, autonomie_clean_cmd.__doc__)
    finally:
        pass
