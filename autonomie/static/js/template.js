...
templates['csv_import_job.mustache'] = template({"1":function(depth0,helpers,partials,data) {
  return "<div class=\"orange_text\">\n<i class=\"fa fa-cog fa-spin fa-4x\"></i><h3>L'import est en cours</h3>\n</div>\n";
  },"3":function(depth0,helpers,partials,data) {
  var stack1, buffer = "\n";
  ...
  return "<div class=\"red_text\"><i class=\"fa fa-warning fa-4x\"></i> <h3>L'import a échoué</h3></div>\n";
  },"6":function(depth0,helpers,partials,data) {
  return "\n<div class=\"green_text\"><i class=\"fa fa-check fa-4x\"></i><h3>L'import s'est déroulé avec succès</h3></div>\n\n<h3>RAPPORT</h3>\n";
  },"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<h1>Importation de données</h1>\n<ul>\n<li>Identifiant de la tâche : "
