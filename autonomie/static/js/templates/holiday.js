...
templates['empty.mustache'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
templates['holidayList.mustache'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "<div>\n    <table class=\"opa table table-bordered table-condensed\">\n        <caption>\n        Vos congés\n            <div class=\"inline-element\">\n                <a class='btn btn-info add' title=\"Déclarer un congés\"><i class='glyphicon glyphicon-plus-sign'></i>&nbsp;Ajouter</a>\n            </div>\n        </caption>\n        <thead>\n            <th>Date de début</th>\n            <th>Date de fin</th>\n            <th>Actions</th>\n        </thead>\n        <tbody>\n        </tbody>\n    </table>\n</div>\n";
  },"useData":true});
