...
templates['product_form.mustache'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "                    </select>\n                </div>\n                <div class=\"form-group\">\n                    <label for='vat_product_id'>Compte produit</label>\n                    <select name='vat_product_id' class='form-control'>\n                    <option value=''></option>\n";
  stack1 = ((helper = (helper = helpers.vat_product_options || (depth0 != null ? depth0.vat_product_options : depth0)) != null ? helper : alias2),(options={"name":"vat_product_options","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.vat_product_options) { stack1 = alias5.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
...
templates['training_group_form.mustache'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  "<form name='training_group'>\n    <div class='row'>\n        <div class='col-md-6'>\n            <fieldset>\n                <legend>Informations relatives au catalogue</legend>\n                <div class=\"form-group\">\n                    <label for='label'>Intitulé de la formation*</label>\n                    <input class=\"form-control\" type='text' name='label' value='"
    ...
    + "</textarea>\n                    <p><i>Villes, zones géographiques où la formation peut être mise en place.</i></p>\n                </div>\n                <div class=\"form-group\">\n                    <label>Modalité de formation</label>\n                    <div>\n                        <input type='checkbox' name='modality_one' ";
  stack1 = ((helper = (helper = helpers.modality_one || (depth0 != null ? depth0.modality_one : depth0)) != null ? helper : alias2),(options={"name":"modality_one","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.modality_one) { stack1 = alias5.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  buffer += "> Intra-entreprise<br>\n                        <input type='checkbox' name='modality_two' ";
  stack1 = ((helper = (helper = helpers.modality_two || (depth0 != null ? depth0.modality_two : depth0)) != null ? helper : alias2),(options={"name":"modality_two","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.modality_two) { stack1 = alias5.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
