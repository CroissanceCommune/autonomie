...
templates['product_group_form.mustache'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "    <form name='product_group'>\n        <div class='row'>\n            <div class='col-md-6'>\n                <fieldset>\n                    <legend>Informations relatives au catalogue</legend>\n                    <div class=\"form-group\">\n                        <label for='label'>Nom de l'ouvrage *</label>\n                        <input class=\"form-control\" type='text' name='label' value='"
    + escapeExpression(((helper = (helper = helpers.label || (depth0 != null ? depth0.label : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"label","hash":{},"data":data}) : helper)))
    + "'/>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for='ref'>Référence</label>\n                        <input class=\"form-control\" type='text' name='ref' value='"
    + escapeExpression(((helper = (helper = helpers.ref || (depth0 != null ? depth0.ref : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"ref","hash":{},"data":data}) : helper)))
...
templates['product_group_item_form.mustache'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, helper, options, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, blockHelperMissing=helpers.blockHelperMissing, buffer = "                    <option value='"
    + escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"id","hash":{},"data":data}) : helper)))
    + "' ";
  stack1 = ((helper = (helper = helpers.selected || (depth0 != null ? depth0.selected : depth0)) != null ? helper : helperMissing),(options={"name":"selected","hash":{},"fn":this.program(2, data),"inverse":this.noop,"data":data}),(typeof helper === functionType ? helper.call(depth0, options) : helper));
  ...
  var stack1, helper, options, functionType="function", helperMissing=helpers.helperMissing, blockHelperMissing=helpers.blockHelperMissing, escapeExpression=this.escapeExpression, buffer = "<form>\n<div class='row'>\n    <div class='col-md-12'>\n        <fieldset>\n            <legend>Configuration des produits composant l'ouvrage</legend>\n            <div class=\"form-group\">\n                <label for='searches'>Produit</label>\n                <select name='product_id' class='form-control'>\n";
  ...
  return buffer + "                </select>\n            </div>\n            <div class='form-group'>\n                <label for='quantity'>Quantité unitaire</label>\n                <input class='form-control' name='quantity' value='"
    ...
    + "' type='number' step='any' min='0' ></input>\n            </div>\n        </fieldset>\n    </div>\n</div>\n<div class='row'>\n    <div class='col-md-6 col-md-offset-6'>\n        <div class=\"form-actions text-right\">\n            <button type=\"submit\" class=\"btn btn-success\" name='submit'>Valider</button>\n            <button type=\"reset\" class=\"btn btn-danger\" name=\"cancel\">Annuler</button>\n        </div>\n    </div>\n</div>\n</form>\n";
},"useData":true});
templates['product_group_item_list.mustache'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "<div class='form well'>\n    <button type=\"button\" class=\"close large-close\"><span aria-hidden=\"true\">&times;</span></button>\n    <h4>Produits composant cet ouvrage\n    <a class='btn btn-primary add' style='font-size: 10px'>Ajouter <i class='glyphicon glyphicon-plus'></i></a>\n    </h4>\n    <table class=\"table table-bordered table-condensed table-striped\">\n        <thead>\n            <th class='col-xs-6'>Produit</th>\n            <th class='col-xs-2'>Quantité Unitaire</th>\n            <th class='col-xs-4 actions'>Actions</th>\n        </thead>\n        <tbody>\n        </tbody>\n    </table>\n</div>\n";
  },"useData":true});
templates['product_group_item.mustache'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<td>\n"
    + escapeExpression(((helper = (helper = helpers.label || (depth0 != null ? depth0.label : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"label","hash":{},"data":data}) : helper)))
    + "\n</td>\n<td>\n"
    + escapeExpression(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"quantity","hash":{},"data":data}) : helper)))
    + "\n</td>\n<td class='action'>\n    <div class=\"btn-group\">\n        <a class='btn btn-success btn-default btn-sm edit' title=\"Modifier cette entrée\">\n            <i class='glyphicon glyphicon-pencil'></i>\n            <span class='visible-lg-inline-block hidden-sm'>\n                Modifier\n            </span>\n        </a>\n        <a class='btn btn-danger btn-default btn-sm remove' title='Supprimer cette entrée'>\n            <i class='glyphicon glyphicon-trash'></i>\n            <span class='visible-lg-inline-block hidden-sm'>\n                Supprimer\n            </span>\n        </a>\n    </div>\n</td>\n";
},"useData":true});
