...
templates['entry.mustache'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<td>\n"
    ...
    + alias4(((helper = (helper = helpers.csv_url || (depth0 != null ? depth0.csv_url : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"csv_url","hash":{},"data":data}) : helper)))
